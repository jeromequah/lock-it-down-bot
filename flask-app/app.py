...
def postLocker():
	...
	try:
		...
		if len(errors) >= 1:
			...
			if locker is None:
				new_locker = Locker(lockerName=lockerName, lockerSchool= lockerSchool, lockerLevel=lockerLevel, lockerNumber = lockerNumber, lockerSize=lockerSize, lockerAvailability = lockerAvailability)
